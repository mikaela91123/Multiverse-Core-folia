...
public class CommandQueueManager {
    ...
    public void addToQueue(CommandQueuePayload payload) {
        ...
        runExpireLater(senderName, config.getConfirmTimeout());
     ...
     */
    private void runExpireLater(@NotNull String senderName, int validDuration) {
        FoliaCompat.runOnGlobalRegionLater(this.plugin, expireRunnable(senderName),
    ...
    public void removeFromQueue(@NotNull String senderName) {
        ...
        // On Folia, we don't get a BukkitTask back, so we rely on the WeakHashMap
        // to clean up naturally. The expire runnable handles the null-check already.
